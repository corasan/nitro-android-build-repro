...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/rnmath/`](android/src/main/java/com/margelo/nitro/rnmath/): All Kotlin implementations.
    - [`NitroRnMathPackage.java`](android/src/main/java/com/margelo/nitro/rnmath/NitroRnMathPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
